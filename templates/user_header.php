...
<aside class="sidebar-left border-right bg-white shadow" id="leftSidebar" data-simplebar>
    ...
    <nav class="vertnav navbar navbar-light">
        ...
        <ul class="navbar-nav flex-fill w-100 mb-2">
            <li class="nav-item w-100">
                <a class="nav-link" href="./all-courses.php">
                    <i class="fe fe-server fe-16"></i>
                    <span class="ml-3 item-text">All Courses</span>
                </a>
            </li>
            <li class="nav-item w-100">
        ...
        <ul class="navbar-nav flex-fill w-100 mb-2">
            ...
            <li class="nav-item w-100">
                <a class="nav-link" href="./my-assignments.php">
                    <i class="fe fe-book-open fe-16"></i>
                    <span class="ml-3 item-text">My Assignments</span>
                </a>
            </li>
            <li class="nav-item w-100">
                <a class="nav-link" href="./my-grades.php">
                    <i class="fe fe-award fe-16"></i>
                    <span class="ml-3 item-text">My Grades</span>
                </a>
            </li>
        </ul>
