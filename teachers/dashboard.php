...
<head>
    ...
    <title>CodeEve | Teacher Dashboard</title>
    <!-- Simple bar CSS -->
                            ...
                            <div class="file-panel mt-4">
                                ...
                                <div class="row">
                                    ...
                                    <table>
                                        <tbody class="d-flex">
                                            <?php 
                                                $sql = "SELECT * FROM teacher_files WHERE teacher_id = '$teacher_id' ORDER BY file_id DESC LIMIT 4";
                                                $result = mysqli_query($conn, $sql);
                                                if($result){
                                                                ...
                                                                <div class="file-action">
                                                                    ...
                                                                    <div class="dropdown-menu m-2">
                                                                        <a class="dropdown-item"
                                                                            href="../teacher-compiler.php?file_id=<?php echo $file_id?>"><i
                                ...
                                <div class="modal-body p-4">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-8">
                                            <label for="eventType">Programming Language <span
                                                    style="color:red;">*</span></label>
