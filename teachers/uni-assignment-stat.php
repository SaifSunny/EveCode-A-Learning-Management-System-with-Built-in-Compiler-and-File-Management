...
<head>
    ...
    <title>CodeEve | Assignment Report</title>
    <!-- Simple bar CSS -->
                ...
                <div class="row justify-content-center">
                    <div class="col-md-12">
                        <div class="row align-items-center my-3">
                            <div class="col">
                                <h2 class="page-title">Assignment Report</h2>
                                                ...
                                                <table class="table table-striped table-hover table-borderless"
                                                    ...
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <?php 
                                                                $sql1 = "SELECT * FROM course_assignments where course_id=$course_id";
                                                                $result1 = mysqli_query($conn, $sql1);
                                                                if($result1){
                                                            ...
                                                            ?>
                                                            <th style="color:#222;">Assignment
                                                                <?php echo $assignment_no?></th>
                                                            <?php
                                                                    }
                                                                }
                                                            ?>
                                                        ...
                                                        <tr style="color:#222;">
                                                            ...
                                                            $count=0;
                                                                    ...
                                                                    if($result5){
                                                                        ...
                                                                        $sql4= "SELECT * FROM course_assignment_complete where assignment_id=$assignment_id AND user_id='$user_id'";
                                                            ...
                                                            ?>
                                                            <td><?php echo $mark =70; $total+=$mark; $count++;?></td>
