    ...
    if(!$query_run->num_rows > 0){
        ...
        if( in_array($imageFileType,$extensions_arr) )
        {
            ...
            if(move_uploaded_file($_FILES['file']['tmp_name'],$target_dir.$name)){
                ...
                $query2 = "INSERT INTO course(course_img, course_name, `level`,`language`, `course_description`, teacher_id, university)
                VALUES ('$name', '$course_name', '$level','$language', '$course_description', '$teacher_id', '$university`')";
                        ...
                        <div class="file-container border-top">
                            <div class="file-panel mt-4">
                                <div class="row my-4 pb-4">
                                    ...
                                    $sql = "SELECT * from course where teacher_id=$teacher_id AND university=$university";
                                    $result = mysqli_query($conn, $sql);
                                    if($result){
