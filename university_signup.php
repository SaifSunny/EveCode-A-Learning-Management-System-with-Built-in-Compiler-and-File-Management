...
if (isset($_SESSION['uniname'])) {
    header("Location: university/university_home.php");
}
    ...
    if ($password == $cpassword) {
            if (strlen($p) > 5) {
                ...
                if (!$query_run->num_rows > 0) {
                    ...
                    if(!$query_run->num_rows > 0){
                        $query2 = "INSERT INTO university(username,email,`password`)
                        ...
                        if ($query_run2) {
                            ...
                            window.location.href='university/profile.php';
                            </script>";
                        } 
                        else {
...
<head>
    ...
    <title>EveCode | University SignUp</title>
    <!-- Simple bar CSS -->
        ...
        <div class="row align-items-center h-100">
            <form class="col-lg-6 col-md-8 col-10 mx-auto" action="" method="POST">
                ...
                <div class="text-center mt-4 font-weight-light">
                    Already have an account? <a href="university_login.php" class="text-primary">Sign In Now.</a>
                </div>
