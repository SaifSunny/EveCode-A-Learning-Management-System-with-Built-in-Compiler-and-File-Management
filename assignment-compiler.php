...
$filename = $row['assignment_no'];
$assignment_title = $row['assignment_title'];
$assignment_Instructions = $row['assignment_Instructions'];
$assignment_code_sample = $row['assignment_code_sample'];
                ...
                <div class="d-flex">
                    <div class="d-flex">
                        <div class="control-panel" style="padding-top:4%; padding-right: 20px;">
                            ...
                            <select id="assignment_id" class="assignment_id" hidden>
                                <option value="<?php echo $assignment_id?>"> <?php echo $assignment_id?></option>
                            </select>
                            &nbsp;
                        </div>
                    </div>
                ...
                <div class="row justify-content-center" style="height: 91.3vh;">
                    ...
                    <div class="col-4" style="height: 91.3vh;overflow-y: scroll;">
                        ...
                        <div style="padding:0 10px;">
                            <h2><?php echo $assignment_title?></h2>
                            <hr>
                            <p style="font-size:15px;"><?php echo $assignment_Instructions?></p>
                            <div class="code-area">
                                <pre class="code-box"><?php echo $assignment_code_sample?></pre>
                            </div>
                        </div>
                        <hr>
                        <div style="padding:0 10px;">
                            ...
                            <div class="code-area">
                                <pre class="code-box"><?php echo $assignment_output?></pre>
                            </div>
                            <p>Note: Output has to be exactly the same otherwise the system will detect the Assignment as incomplete</p>
                        </div>
    ...
    <script>
        ...
        function executeCode() {
            ...
            $.ajax({
                ...
                url: "./ide/assignment_compiler_run.php",
