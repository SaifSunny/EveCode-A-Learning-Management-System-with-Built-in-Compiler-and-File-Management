	...
	if ($result->num_rows > 0) {
        ...
        if ($result->num_rows > 0) {
            ...
            if ($result->num_rows > 0) {
                ...
                $sql = "INSERT INTO recent(`image`, `name`, `role`, `date`) VALUES ((SELECT `user_img` FROM users WHERE username='$username'), '$username', 'User', '$date')";
                $result = mysqli_query($conn, $sql);
...
<head>
    ...
    <title>EveCode | User Login</title>
    <!-- Simple bar CSS -->
        ...
        <div class="row align-items-center h-100">
            <form class="col-lg-3 col-md-4 col-10 mx-auto" action="" method="POST">
                ...
                <div class="text-center mt-4 font-weight-light">
                  Don't have an account? <a href="user_signup.php" class="text-primary">Create an Account.</a>
