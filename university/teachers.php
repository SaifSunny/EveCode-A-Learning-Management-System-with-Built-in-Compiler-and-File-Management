            ...
            if(!$query_run->num_rows > 0){
                ...
                if( in_array($imageFileType,$extensions_arr) ){
                    ...
                    if(move_uploaded_file($_FILES['file']['tmp_name'],$target_dir.$name)){
                        ...
                        // Convert to base64 
                        $image_base64 = base64_encode(file_get_contents('../images/teachers/'.$name));
                        $image = 'data:image/'.$imageFileType.';base64,'.$image_base64;

                        // Insert record

                        $query2 = "INSERT INTO teachers(username,email,`password`,firstname,lastname,contact,gender,birthday,teacher_img, `address`, city, zip, university)
                        VALUES ('$username', '$email', '$password', '$firstname', '$lastname', '$contact', '$gender', '$birthday', '$name', '$address', '$city', '$zip', $university_id)";
                        ...
                        mkdir("C:/xampp/htdocs/EveCode/ide/".$username, 0777);
                            ...
                            $cls="success";
                            $error = "Teacher Successfully Added.";
                        } 
                        else {
                            $cls="danger";
...
if(isset($_POST['delete_teacher'])){
    ...
    $query_run = mysqli_query($conn, $query);
        if ($query_run) {
            $cls="success";
            $error = "Teacher Successfully Deleted.";
        } else {
            $cls="danger";
            $error = mysqli_error($conn);
        }
...
<head>
    ...
    <title>CodeEve | Manage Teachers</title>
    <!-- Simple bar CSS -->
            ...
            <div class="container-fluid">
                                    ...
                                    <div class="col-md-12 col-lg-12">
                                        <div class="card shadow">
                                            <div class="card-header">
                                                <strong class="card-title" style="font-size:18px;">Teacher Details</strong>
                                                <a class="float-right small btn btn-primary" style="padding:5px 10px;"
                                                    href="#!" data-toggle="modal" data-target="#addModal">Add Teacher</a>
                                            ...
                                            <div class="alert alert-<?php echo $cls;?>">
                                                ...
                                                <table class="table table-striped table-hover table-borderless">
                                                    ...
                                                    <tbody>
                                                        <?php 
                                                            $sql1 = "SELECT * FROM teachers where university=$university_id";
                                                            ...
                                                            if($result1){
                                                                ...
                                                                $city=$row1['city'];
                                                                $zip=$row1['zip'];
                                                                $image=$row1['teacher_img'];
                                                                $teacher_id=$row1['teacher_id'];

                                                        ?>
                                                        <tr>
                                                            <td><?php echo $teacher_id ?></td>
                                                            <td><img src="../images/teachers/<?php echo $image ?>"
                ...
                <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="eventModalLabel"
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="varyModalLabel">Add Teacher</h5>
                            ...
                            <form action="" method="POST" enctype='multipart/form-data'>
                                ...
                                <div class="modal-footer d-flex justify-content-between">
                                    <button type="submit" name="add_teacher" class="btn mb-2 btn-primary">Add Teacher</button>
                                </div>
                            </form>
                        </div>
                    </div>
