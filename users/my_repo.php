...
<head>
    ...
    <title>EveCode | User Repos</title>
    <!-- Simple bar CSS -->
                    ...
                    <div class="col">
                        ...
                        <div class="row mb-4" style="padding-left:30px;">
                            <div class="col-md-7">
                                ...
                                <p class="small mb-0">Number of Repo: <?php echo count(glob("C:/xampp/htdocs/EveCode/ide/$username/*"))?></p>
                                <?php
                                ...
                                <td class="text-center" style="display:none;">
                                    ...
                                    <td>
                                        <div class="file-action">
                                            ...
                                            <a class="dropdown-item" href="../compiler.php?file_id=<?php echo $file_id?>"><i
