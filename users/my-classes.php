...
<head>
    ...
    <title>CodeEve | My Classes</title>
    <!-- Simple bar CSS -->
...
<body class="vertical  light  ">
    <div class="wrapper">
        ...
        <main role="main" class="main-content">
                        ...
                        <div class="row align-items-center mb-4">
                            ...
                            <div class="col-auto">
                                <button type="button" class="btn btn-lg btn-primary" data-toggle="modal"
                                    data-target="#joinclass"><span class="fe fe-plus fe-16 mr-3"></span>Join
                                    Class</button>
                            </div>
                        </div>
                                                    ...
                                                    <li class="list-group-item">
                                                        <div class="d-flex justify-content-between">
                                                            <?php
                                                                ...
                                                                $sql5= "SELECT * FROM university WHERE university_id='$university'";
                                                                $result5 = mysqli_query($conn, $sql5);
                                                                $row5=mysqli_fetch_assoc($result5);
                                                                $uni_username=$row5['username'];
                                                            ?>
                                                            <span><img
                                                                ...
                                                                <span
                                                                    ...
                                                                    <h6 class="m-2"><?php echo $uni_username?>
                                                        </div>
                                                    </li>
            ...
            <!-- new event modal -->
            <div class="modal fade" id="joinclass" tabindex="-1" role="dialog" aria-labelledby="eventModalLabel"
                aria-hidden="true" style="padding-top: 100px;">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="varyModalLabel">Join Class</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <form action="uni-course-enroll.php" method="POST">
                            <div class="modal-body p-4">
                                <div class="form-group">
                                    <label for="code" class="col-form-label">Class Code</label>
                                    <input type="text" class="form-control" id="code" name="code"
                                        placeholder="Joining Code">
                                </div>
                                <div class="form-group">
                                    <h6 class="mb-2">Ask your Academic teacher for the joining to join your academic
                                        courses.</h6>
                                </div>
                            </div>
                            <div class="modal-footer d-flex justify-content-between">
                                <button type="submit" name="submit" class="btn mb-2 btn-primary">Join Class</button>
                            </div>
                        </form>
