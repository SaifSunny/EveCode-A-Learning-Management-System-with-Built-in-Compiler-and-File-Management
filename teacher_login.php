	...
	if ($result->num_rows > 0) {
        ...
        if ($result->num_rows > 0) {
            ...
            if ($result->num_rows > 0) {
                ...
                $sql = "INSERT INTO recent(`image`, `name`, `role`, `date`) VALUES ((SELECT `teacher_img` FROM teachers WHERE username='$username'), '$username', 'Teacher', '$date')";
                $result = mysqli_query($conn, $sql);
...
<head>
    ...
    <title>EveCode | Teacher Login</title>
    <!-- Simple bar CSS -->
        ...
        <div class="row align-items-center h-100">
            <form class="col-lg-3 col-md-4 col-10 mx-auto" action="" method="POST">
                ...
                <div class="text-center mt-4 font-weight-light">
                  Don't have an account? <a href="teacher_signup.php" class="text-primary">Create an Account.</a>
