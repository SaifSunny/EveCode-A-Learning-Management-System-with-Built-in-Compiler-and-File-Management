...
if(isset($_POST['add_university'])){
    ...
    if (strlen($p) > 5) {
        ...
        if (!$query_run->num_rows > 0) {
            ...
            $query = "SELECT * FROM university WHERE username = '$username' AND email = '$email'";
            $query_run = mysqli_query($conn, $query);
            if(!$query_run->num_rows > 0){
                ...
                if( in_array($imageFileType,$extensions_arr) ){
                    ...
                    if(move_uploaded_file($_FILES['file']['tmp_name'],$target_dir.$name)){
                        ...
                        $query2 = "INSERT INTO university(username,email,`password`,university_name,contact,established,university_img, `address`, city, zip)
                        VALUES ('$username', '$email', '$password', '$university_name', '$contact', '$established', '$name', '$address', '$city', '$zip')";
                        $query_run2 = mysqli_query($conn, $query2);
                        mkdir("C:/xampp/htdocs/EveCode/ide/".$username, 0777);
            
                        if ($query_run2) {
                            $cls="success";
                            $error = "University Successfully Added.";
                        } 
                        else {
                            $cls="danger";
...
if(isset($_POST['delete_university'])){
    ...
    $university_id = $_POST['delete_id'];

    $query = "DELETE FROM university WHERE university_id='$university_id'";
    $query_run = mysqli_query($conn, $query);
        if ($query_run) {
            $cls="success";
            $error = "University Successfully Deleted.";
        } else {
            $cls="danger";
            $error = mysqli_error($conn);
        }
...
<head>
    ...
    <title>CodeEve | Manage Universities</title>
    <!-- Simple bar CSS -->
            ...
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-md-12">
                        <div class="row align-items-center my-3">
                            <div class="col">
                                <h2 class="page-title">Manage Universities</h2>
                                    ...
                                    <div class="col-md-12 col-lg-12">
                                        <div class="card shadow">
                                            <div class="card-header">
                                                <strong class="card-title" style="font-size:18px;">University Details</strong>
                                                <?php
                                                ...
                                                <div class="float-right">
                                                    Total Universities: <?php echo $count?>
                                                    <a class="small btn btn-primary" style="padding:5px 10px;margin-left:20px;"
                                                    href="#!" data-toggle="modal" data-target="#addModal">Add University</a>
                                                </div>
                                            ...
                                            <div class="alert alert-<?php echo $cls;?>">
                                                <?php 
                                                            if (isset($_POST['add_university']) || isset($_POST['delete_university'])){
                                                                echo $error;
                                                            }
                                                        ?>
                                            </div>
                                                    ...
                                                    <tbody>
                                                        <?php 
                                                            ...
                                                            if($result1){
                                                                ...
                                                                $established=$row1['established'];
                                                                $contact=$row1['contact'];
                                                                $email=$row1['email'];
                                                                $address=$row1['address'];
                                                                $city=$row1['city'];
                                                                $zip=$row1['zip'];
                                                                $image=$row1['university_img'];
                                                                $university_id=$row1['university_id'];

                                                        ?>
                                                        <tr>
                                                            <td><?php echo $university_id ?></td>
                                                            <td><img src="../images/universities/<?php echo $image ?>"
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <form action="" method="POST">
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <button type="submit" name="delete_university"
                ...
                <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="eventModalLabel"
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="varyModalLabel">Add University</h5>
                            ...
                            <form action="" method="POST" enctype='multipart/form-data'>
                                ...
                                <div class="modal-footer d-flex justify-content-between">
                                    <button type="submit" name="add_university" class="btn mb-2 btn-primary">Add University</button>
                                </div>
                            </form>
                        </div>
                    </div>
