...
<head>
    ...
    <title>CodeEve | Admin Dashboard</title>
    <!-- Simple bar CSS -->
                                        ...
                                        <div class="card shadow mb-6">
                                            <div class="card-body">
                                                <div class="row align-items-center">
                                                    <div class="col">
                                                        <p class="mb-1" style="font-size:16px;">Users</p>
                                                        <?php
                                    ...
                                    <div class="col-md-3">
                                        <div class="card shadow mb-6">
                                            <div class="card-body">
                                                <div class="row align-items-center">
                                                    <div class="col">
                                                        <p class="mb-1" style="font-size:16px;">Universities</p>
                                                        <?php
                                                ...
                                                <div class="pb-3 timeline-item">
                                                    <div class="pl-5">
                                                        <div class="mb-1" style="font-size:18px;">
                                                            ...
                                                            <?php
                                                                $dir_path ="C:/xampp/htdocs/EveCode/ide/temp";
                                        ...
                                        <div class="card shadow">
                                            ...
                                            <div class="card-body my-n2"
                                                ...
                                                <table class="table table-striped table-hover table-borderless">
                                                    ...
                                                    <tbody>
                                                        <?php 
                                                            $sql = "SELECT DISTINCT `name`, `role`, `image`, `date` FROM recent ORDER BY sl DESC LIMIT 7;";
                                                            $result = mysqli_query($conn, $sql);
                                                            if($result){
                                                        ...
                                                        ?>
                                                        <tr>
                                                            <td><img src="<?php echo $path."/".$image?>" alt=""
                                                                    width="50"></td>
