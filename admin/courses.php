    ...
    if(!$query_run->num_rows > 0){
        ...
        if( in_array($imageFileType,$extensions_arr) )
        {
            ...
            if(move_uploaded_file($_FILES['file']['tmp_name'],$target_dir.$name)){
                ...
                $query2 = "INSERT INTO course(course_img, course_name, `level`,`language`, `course_description`, teacher_id)
                VALUES ('$name', '$course_name', '$level','$language', '$course_description', '$teacher_id')";
