            ...
            if(!$query_run->num_rows > 0){
                ...
                if( in_array($imageFileType,$extensions_arr) ){
                    ...
                    if(move_uploaded_file($_FILES['file']['tmp_name'],$target_dir.$name)){
                        ...
                        $query2 = "INSERT INTO teachers(username,email,`password`,firstname,lastname,contact,gender,birthday,teacher_img, `address`, city, zip)
